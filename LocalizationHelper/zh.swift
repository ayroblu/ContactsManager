...
let zhHant = [
  ...
  """: """
    感謝您支持我並下載 ContactsManager！

    您需要授予對您的聯繫人的訪問權限才能使此應用程序正常工作

    您的聯繫人數據永遠不會發送給任何人並保留在設備上！
    """,
...
let zhHantInfo = [
  "NSContactsUsageDescription": "這是獲取和更新您的聯繫人和聯繫人組所必需的"
]
